...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const posts = [
        ...
        },
        {
            ...
            description: 'QR Code Generator adalah alat yang memungkinkan pengguna untuk membuat kode QR dengan mudah dan cepat. Pengguna dapat menghasilkan kode QR untuk berbagai tujuan, seperti berbagi konten, mengarahkan ke situs web, atau mengirimkan pesan.',
            link: 'blog/kontenblog/QR Code Generator/index.html',
